...
# indicating speed, and a trajectory video showing the paths of tracked objects. This is same as main.py
# except it also displays the frames in real-time windows without saving time info.
###########################################################################################################
...
video_path = os.path.join('.', 'data', 'input_video_2.mp4')
...
model = YOLO("model_obj_detector/best.pt", "v8")
